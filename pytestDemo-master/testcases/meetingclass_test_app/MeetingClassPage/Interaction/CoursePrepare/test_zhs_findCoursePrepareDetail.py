...
class Test_findCoursePrepareDetail():
    """app查看备课卡片的详细信息"""

    @allure.story("互动-备课")
    @allure.description("app查看备课卡片下的互动")
    @allure.title("app查看备课卡片下的互动")
    @pytest.mark.single
    def test_zhs_findCoursePrepareDetail(self, login_fixture_teacher_app):
        logger.info("*************** 开始执行用例 ***************")
        # login_fixture前置登录
...
if __name__ == '__main__':
    pytest.main(["-q", "-s", "test_zhs_findCoursePrepareDetail.py"])
