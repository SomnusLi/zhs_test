...
class Test_getMeetCourseLivingShareUrl():
    """查询直播分享链接"""

    @allure.story("用例--查询直播分享链接")
    @allure.description("该用例是查询直播分享链接")
    ...
    def test_zhs_getMeetCourseLivingShareUrl(self, login_fixture_teacher):
...
if __name__ == '__main__':
    pytest.main(["-q", "-s", "test_zhs_getMeetCourseLivingShareUrl.py"])
