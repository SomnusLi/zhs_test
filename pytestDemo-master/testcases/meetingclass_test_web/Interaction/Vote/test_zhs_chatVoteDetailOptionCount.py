...
class Test_chatVoteDetailOptionCount():
    """查询投票选项信息"""

    @allure.story("用例--查询投票选项信息")
    @allure.description("该用例查询投票选项信息")
    ...
    @allure.title(
        "测试数据：上游业务获取")
    @pytest.mark.single
    def test_zhs_chatVoteDetailOptionCount(self, login_fixture_teacher):
        logger.info("*************** 开始执行用例 ***************")
        # login_fixture前置登录
...
if __name__ == '__main__':
    pytest.main(["-q", "-s", "test_zhs_chatVoteDetailOptionCount.py"])
